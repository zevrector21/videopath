...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'TotalAnalyticsData'
        db.create_table(u'analytics_totalanalyticsdata', (
            ...
            ('total_plays_all', self.gf(
                'django.db.models.fields.IntegerField')(default=0)),
            ('total_play_unique', self.gf(
                'django.db.models.fields.IntegerField')(default=0)),
            ('overlays_opened_all', self.gf(
                'django.db.models.fields.IntegerField')(default=0)),
            ('overlays_opened_unique', self.gf(
                'django.db.models.fields.IntegerField')(default=0)),
            ('avg_session_time', self.gf(
                'django.db.models.fields.FloatField')(default=0)),
            ('popular_markers', self.gf(
                'django.db.models.fields.TextField')(default='{}')),
            ('video', self.gf('django.db.models.fields.related.ForeignKey')
             (related_name='total_analytics', to=orm['videos.Video'])),
        ))
        db.send_create_signal(u'analytics', ['TotalAnalyticsData'])

    def backwards(self, orm):
        # Deleting model 'TotalAnalyticsData'
        db.delete_table(u'analytics_totalanalyticsdata')
    ...
    models = {
        u'analytics.totalanalyticsdata': {
            ...
            'total_play_unique': ('django.db.models.fields.IntegerField', [], {'default': '0'}),
            'total_plays_all': ('django.db.models.fields.IntegerField', [], {'default': '0'}),
