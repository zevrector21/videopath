...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'TotalAnalyticsData.total_plays_all'
        db.delete_column(u'analytics_totalanalyticsdata', 'total_plays_all')

        # Deleting field 'TotalAnalyticsData.total_play_unique'
        db.delete_column(u'analytics_totalanalyticsdata', 'total_play_unique')

        # Adding field 'TotalAnalyticsData.plays_all'
        db.add_column(u'analytics_totalanalyticsdata', 'plays_all',
                      self.gf('django.db.models.fields.IntegerField')(
                          default=0),
                      keep_default=False)

        # Adding field 'TotalAnalyticsData.plays_unique'
        db.add_column(u'analytics_totalanalyticsdata', 'plays_unique',
                      self.gf('django.db.models.fields.IntegerField')(
                          default=0),
                      keep_default=False)

    def backwards(self, orm):
        # Adding field 'TotalAnalyticsData.total_plays_all'
        db.add_column(u'analytics_totalanalyticsdata', 'total_plays_all',
                      self.gf('django.db.models.fields.IntegerField')(
                          default=0),
                      keep_default=False)

        # Adding field 'TotalAnalyticsData.total_play_unique'
        db.add_column(u'analytics_totalanalyticsdata', 'total_play_unique',
                      self.gf('django.db.models.fields.IntegerField')(
                          default=0),
                      keep_default=False)

        # Deleting field 'TotalAnalyticsData.plays_all'
        db.delete_column(u'analytics_totalanalyticsdata', 'plays_all')

        # Deleting field 'TotalAnalyticsData.plays_unique'
        db.delete_column(u'analytics_totalanalyticsdata', 'plays_unique')
