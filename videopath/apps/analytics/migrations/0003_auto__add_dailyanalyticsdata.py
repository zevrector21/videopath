...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'DailyAnalyticsData'
        db.create_table(u'analytics_dailyanalyticsdata', (
            ...
            ('video', self.gf('django.db.models.fields.related.ForeignKey')
             (related_name='daily_analytics', to=orm['videos.Video'])),
            ('date', self.gf('django.db.models.fields.DateTimeField')()),
        ))
        db.send_create_signal(u'analytics', ['DailyAnalyticsData'])

    def backwards(self, orm):
        # Deleting model 'DailyAnalyticsData'
        db.delete_table(u'analytics_dailyanalyticsdata')
