...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'TotalAnalyticsData.video_completed'
        db.add_column(u'analytics_totalanalyticsdata', 'video_completed',
                      self.gf('django.db.models.fields.IntegerField')(
                          default=0),
                      keep_default=False)

        # Adding field 'DailyAnalyticsData.video_completed'
        db.add_column(u'analytics_dailyanalyticsdata', 'video_completed',
                      self.gf('django.db.models.fields.IntegerField')(
                          default=0),
                      keep_default=False)

    def backwards(self, orm):
        # Deleting field 'TotalAnalyticsData.video_completed'
        db.delete_column(u'analytics_totalanalyticsdata', 'video_completed')

        # Deleting field 'DailyAnalyticsData.video_completed'
        db.delete_column(u'analytics_dailyanalyticsdata', 'video_completed')
