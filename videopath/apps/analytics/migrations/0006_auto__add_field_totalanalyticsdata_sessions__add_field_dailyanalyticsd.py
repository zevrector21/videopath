...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'TotalAnalyticsData.sessions'
        db.add_column(u'analytics_totalanalyticsdata', 'sessions',
                      self.gf('django.db.models.fields.IntegerField')(
                          default=0),
                      keep_default=False)

        # Adding field 'DailyAnalyticsData.sessions'
        db.add_column(u'analytics_dailyanalyticsdata', 'sessions',
                      self.gf('django.db.models.fields.IntegerField')(
                          default=0),
                      keep_default=False)

    def backwards(self, orm):
        # Deleting field 'TotalAnalyticsData.sessions'
        db.delete_column(u'analytics_totalanalyticsdata', 'sessions')

        # Deleting field 'DailyAnalyticsData.sessions'
        db.delete_column(u'analytics_dailyanalyticsdata', 'sessions')
    ...
    models = {
        u'analytics.dailyanalyticsdata': {
            ...
            'sessions': ('django.db.models.fields.IntegerField', [], {'default': '0'}),
            'video': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'daily_analytics'", 'to': u"orm['videos.Video']"}),
            'video_completed': ('django.db.models.fields.IntegerField', [], {'default': '0'})
        },
        ...
        u'videos.videorevision': {
            ...
            'endscreen_subtitle': ('django.db.models.fields.CharField', [], {'max_length': '512', 'blank': 'True'}),
