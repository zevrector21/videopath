...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'VideoFile.thumbnail_index'
        db.add_column(u'files_videofile', 'thumbnail_index',
                      self.gf('django.db.models.fields.SmallIntegerField')(
                          default=0),
                      keep_default=False)

    def backwards(self, orm):
        # Deleting field 'VideoFile.thumbnail_index'
        db.delete_column(u'files_videofile', 'thumbnail_index')
