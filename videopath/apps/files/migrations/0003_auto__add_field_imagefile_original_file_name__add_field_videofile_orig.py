...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ImageFile.original_file_name'
        db.add_column(u'files_imagefile', 'original_file_name',
                      self.gf('django.db.models.fields.CharField')(
                          default='', max_length=255, blank=True),
                      keep_default=False)

        # Adding field 'VideoFile.original_file_name'
        db.add_column(u'files_videofile', 'original_file_name',
                      self.gf('django.db.models.fields.CharField')(
                          default='', max_length=255, blank=True),
                      keep_default=False)

    def backwards(self, orm):
        # Deleting field 'ImageFile.original_file_name'
        db.delete_column(u'files_imagefile', 'original_file_name')

        # Deleting field 'VideoFile.original_file_name'
        db.delete_column(u'files_videofile', 'original_file_name')
