...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'VideoFile.original_bytes'
        db.add_column(u'files_videofile', 'original_bytes',
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'VideoFile.original_bytes'
        db.delete_column(u'files_videofile', 'original_bytes')
