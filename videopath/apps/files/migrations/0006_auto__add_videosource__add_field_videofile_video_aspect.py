...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'files_videosource', (
            ...
            ('video', self.gf('django.db.models.fields.related.ForeignKey')
             (related_name='video_sources', to=orm['videos.Video'])),
            ('service', self.gf('django.db.models.fields.CharField')
             (default='none', max_length=255)),
            ('status', self.gf(
                'django.db.models.fields.SmallIntegerField')(default=0)),
            ('service_identifier', self.gf('django.db.models.fields.CharField')(
            ...
            ('video_aspect', self.gf(
                'django.db.models.fields.FloatField')(default=0)),
            ('thumbnail_url', self.gf('django.db.models.fields.CharField')
             (default='', max_length=2048)),
        ))
        db.send_create_signal(u'files', ['VideoSource'])

        # Adding field 'VideoFile.video_aspect'
        db.add_column(u'files_videofile', 'video_aspect',
                      self.gf('django.db.models.fields.FloatField')(default=0),
                      keep_default=False)

    def backwards(self, orm):
        # Deleting model 'VideoSource'
        db.delete_table(u'files_videosource')

        # Deleting field 'VideoFile.video_aspect'
        db.delete_column(u'files_videofile', 'video_aspect')
    ...
    models = {
        ...
        u'files.videosource': {
            ...
            'video': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'video_sources'", 'to': u"orm['videos.Video']"}),
            'video_aspect': ('django.db.models.fields.FloatField', [], {'default': '0'}),
            'video_duration': ('django.db.models.fields.FloatField', [], {'default': '0'}),
            'video_height': ('django.db.models.fields.SmallIntegerField', [], {'default': '0'}),
            'video_width': ('django.db.models.fields.SmallIntegerField', [], {'default': '0'})
