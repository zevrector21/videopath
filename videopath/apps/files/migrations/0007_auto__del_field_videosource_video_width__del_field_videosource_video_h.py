...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'VideoSource.video_width'
        db.delete_column(u'files_videosource', 'video_width')

        # Deleting field 'VideoSource.video_height'
        db.delete_column(u'files_videosource', 'video_height')

    def backwards(self, orm):
        # Adding field 'VideoSource.video_width'
        db.add_column(u'files_videosource', 'video_width',
                      self.gf('django.db.models.fields.SmallIntegerField')(
                          default=0),
                      keep_default=False)

        # Adding field 'VideoSource.video_height'
        db.add_column(u'files_videosource', 'video_height',
                      self.gf('django.db.models.fields.SmallIntegerField')(
                          default=0),
                      keep_default=False)
