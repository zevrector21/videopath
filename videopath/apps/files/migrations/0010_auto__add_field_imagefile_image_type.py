...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ImageFile.image_type'
        db.add_column(u'files_imagefile', 'image_type',
                      self.gf('django.db.models.fields.CharField')(
                          default='marker content', max_length=255, blank=True),
                      keep_default=False)

    def backwards(self, orm):
        # Deleting field 'ImageFile.image_type'
        db.delete_column(u'files_imagefile', 'image_type')
