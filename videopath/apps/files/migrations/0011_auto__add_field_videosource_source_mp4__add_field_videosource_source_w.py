...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'VideoSource.source_mp4'
        db.add_column(u'files_videosource', 'source_mp4',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=512),
                      keep_default=False)

        # Adding field 'VideoSource.source_webm'
        db.add_column(u'files_videosource', 'source_webm',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=512),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'VideoSource.source_mp4'
        db.delete_column(u'files_videosource', 'source_mp4')

        # Deleting field 'VideoSource.source_webm'
        db.delete_column(u'files_videosource', 'source_webm')
    ...
    models = {
        ...
        u'files.videosource': {
            ...
            'source_mp4': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '512'}),
            'source_webm': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '512'}),
            'status': ('django.db.models.fields.SmallIntegerField', [], {'default': '0'}),
