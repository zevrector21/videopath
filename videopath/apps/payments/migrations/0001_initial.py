    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('provider', models.CharField(default=b'other', max_length=150, choices=[(b'other', b'other'), (b'stripe', b'stripe'), (b'transfer', b'transfer')])),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('created', models.DateTimeField(auto_now_add=True)),
                ('modified', models.DateTimeField(auto_now=True)),
                ('plan', models.CharField(default=b'free-free', max_length=150, choices=[(b'free-free', b'0001 Free (free-free)'), (b'201410-starter-monthly', b'0010 Basic Monthly (201410-starter-monthly)'), (b'201412-starter-monthly', b'0010 Basic Monthly (201412-starter-monthly)'), (b'201412-starter-yearly', b'0011 Basic Yearly (201412-starter-yearly)'), (b'201410-starter-yearly', b'0011 Basic Yearly (201410-starter-yearly)'), (b'201412-pro-plus-monthly', b'0150 Professional Plus Monthly (201412-pro-plus-monthly)'), (b'201412-pro-plus-yearly', b'0151 Professional Plus Yearly (201412-pro-plus-yearly)'), (b'201412-enterprise-monthly', b'0200 Enterprise Monthly (201412-enterprise-monthly)'), (b'201412-enterprise-yearly', b'0201 Enterprise Yearly (201412-enterprise-yearly)'), (b'individual-staff', b'9999 videopath staff account (individual-staff)'), (b'individual-escp', b'9999 Individual escp (individual-escp)'), (b'individual-agency-evaluation', b'9999 Agency Evaluation (individual-agency-evaluation)'), (b'individual-individual', b'9999 Individual Plan (individual-individual)'), (b'individual-meisterclass', b'9999 Individual meisterclasss (individual-meisterclass)'), (b'individual-sspss', b'9999 Individual SSPSS (individual-sspss)'), (b'individual-lonelycaballero', b'9999 Individual lonelycaballero (individual-lonelycaballero)')])),
