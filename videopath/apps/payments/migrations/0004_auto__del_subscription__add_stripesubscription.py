...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'payments_stripesubscription', (
            ...
            ('customer', self.gf('django.db.models.fields.related.ForeignKey')(
                related_name='subscriptions', to=orm['payments.StripeCustomer'])),
    ...
    models = {
        ...
        u'payments.stripesubscription': {
            ...
            'customer': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'subscriptions'", 'to': u"orm['payments.StripeCustomer']"}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
