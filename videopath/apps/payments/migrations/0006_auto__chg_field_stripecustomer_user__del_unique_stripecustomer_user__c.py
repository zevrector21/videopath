...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Removing unique constraint on 'StripeCard', fields ['customer']
        db.delete_unique(u'payments_stripecard', ['customer_id'])

        # Removing unique constraint on 'StripeCustomer', fields ['user']
        db.delete_unique(u'payments_stripecustomer', ['user_id'])

        # Changing field 'StripeCustomer.user'
        db.alter_column(u'payments_stripecustomer', 'user_id', self.gf(
            'django.db.models.fields.related.ForeignKey')(to=orm['auth.User']))

        # Changing field 'StripeCard.customer'
        db.alter_column(u'payments_stripecard', 'customer_id', self.gf(
    ...
    def backwards(self, orm):
        ...
        db.create_unique(u'payments_stripecustomer', ['user_id'])

        # Changing field 'StripeCard.customer'
        db.alter_column(u'payments_stripecard', 'customer_id', self.gf(
            'django.db.models.fields.related.OneToOneField')(unique=True, null=True, to=orm['payments.StripeCustomer']))
        # Adding unique constraint on 'StripeCard', fields ['customer']
        db.create_unique(u'payments_stripecard', ['customer_id'])
    ...
    models = {
        ...
        u'payments.stripecard': {
            ...
            'created': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'customer': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'cards'", 'null': 'True', 'to': u"orm['payments.StripeCustomer']"}),
        ...
        u'payments.stripecustomer': {
            ...
            'key': ('django.db.models.fields.CharField', [], {'unique': 'True', 'max_length': '50', 'db_index': 'True'}),
            'modified': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'blank': 'True'}),
            'user': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'stripe_customers'", 'to': u"orm['auth.User']"})
        },
