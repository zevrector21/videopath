...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'PaymentDetails.id'
        db.delete_column(u'payments_paymentdetails', u'id')

        # Changing field 'PaymentDetails.user'
        db.alter_column(u'payments_paymentdetails', 'user_id', self.gf(
            'django.db.models.fields.related.OneToOneField')(unique=True, primary_key=True, to=orm['auth.User']))
    ...
    def backwards(self, orm):
        ...
        # 'PaymentDetails.id'
        raise RuntimeError(
            "Cannot reverse this migration. 'PaymentDetails.id' and its values cannot be restored.")

        # The following code is provided here to aid in writing a correct
        # migration        # Adding field 'PaymentDetails.id'
        db.add_column(u'payments_paymentdetails', u'id',
