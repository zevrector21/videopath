...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'StripeInvoice.number'
        db.add_column(u'payments_stripeinvoice', 'number',
                      self.gf('django.db.models.fields.IntegerField')(
                          default=0),
                      keep_default=False)

    def backwards(self, orm):
        # Deleting field 'StripeInvoice.number'
        db.delete_column(u'payments_stripeinvoice', 'number')
