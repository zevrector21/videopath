...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'StripeSubscription.cancel_at_period_end'
        db.add_column(u'payments_stripesubscription', 'cancel_at_period_end',
                      self.gf('django.db.models.fields.BooleanField')(
                          default=False),
                      keep_default=False)

    def backwards(self, orm):
        # Deleting field 'StripeSubscription.cancel_at_period_end'
        db.delete_column(
            u'payments_stripesubscription', 'cancel_at_period_end')
