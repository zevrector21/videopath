...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Subscription.managed_by'
        db.add_column(u'payments_subscription', 'managed_by',
                      self.gf('django.db.models.fields.CharField')(
                          default='admin', max_length=255),
                      keep_default=False)

    def backwards(self, orm):
        # Deleting field 'Subscription.managed_by'
        db.delete_column(u'payments_subscription', 'managed_by')
