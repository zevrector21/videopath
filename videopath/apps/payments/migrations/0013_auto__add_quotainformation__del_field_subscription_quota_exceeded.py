...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'QuotaInformation'
        db.create_table(u'payments_quotainformation', (
            ('created', self.gf('django.db.models.fields.DateTimeField')
             (auto_now_add=True, blank=True)),
            ('modified', self.gf('django.db.models.fields.DateTimeField')
             (auto_now=True, blank=True)),
            ('quota_exceeded', self.gf(
                'django.db.models.fields.BooleanField')(default=False)),
            ('warning_sent', self.gf(
                'django.db.models.fields.BooleanField')(default=False)),
            ('user', self.gf('django.db.models.fields.related.OneToOneField')(
                related_name='quota_info', unique=True, primary_key=True, to=orm['auth.User'])),
        ))
        db.send_create_signal(u'payments', ['QuotaInformation'])

        # Deleting field 'Subscription.quota_exceeded'
        db.delete_column(u'payments_subscription', 'quota_exceeded')

    def backwards(self, orm):
        # Deleting model 'QuotaInformation'
        db.delete_table(u'payments_quotainformation')

        # Adding field 'Subscription.quota_exceeded'
        db.add_column(u'payments_subscription', 'quota_exceeded',
