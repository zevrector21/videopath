...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Subscription.custom_price'
        db.add_column(u'payments_subscription', 'custom_price',
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'Subscription.custom_price'
        db.delete_column(u'payments_subscription', 'custom_price')

        # Deleting field 'Subscription.custom_price_periods_remaining'
        db.delete_column(
            u'payments_subscription', 'custom_price_periods_remaining')
