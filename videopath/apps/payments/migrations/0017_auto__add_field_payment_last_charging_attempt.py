...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Payment.last_charging_attempt'
        db.add_column(u'payments_payment', 'last_charging_attempt',
                      self.gf('django.db.models.fields.DateField')(null=True),
                      keep_default=False)

    def backwards(self, orm):
        # Deleting field 'Payment.last_charging_attempt'
        db.delete_column(u'payments_payment', 'last_charging_attempt')
