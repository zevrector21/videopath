...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Payment.provider'
        db.add_column(u'payments_payment', 'provider',
                      self.gf('django.db.models.fields.CharField')(
                          default='other', max_length=150),
                      keep_default=False)

        # Adding field 'Payment.transaction_id'
        db.add_column(u'payments_payment', 'transaction_id',
                      self.gf('django.db.models.fields.CharField')(
                          default='', max_length=150),
                      keep_default=False)

    def backwards(self, orm):
        # Deleting field 'Payment.provider'
        db.delete_column(u'payments_payment', 'provider')

        # Deleting field 'Payment.transaction_id'
        db.delete_column(u'payments_payment', 'transaction_id')
