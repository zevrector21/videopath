...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'payments_payment', 'date', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, null=True))
        # Adding field 'Subscription.notes'
        db.add_column(u'payments_subscription', 'notes',
    ...
    def backwards(self, orm):
        ...
        # Changing field 'Payment.date'
        db.alter_column(u'payments_payment', 'date', self.gf('django.db.models.fields.DateTimeField')(null=True))
        # Deleting field 'Subscription.notes'
        db.delete_column(u'payments_subscription', 'notes')
