...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'OneTimeAuthenticationToken'
        db.create_table(u'users_onetimeauthenticationtoken', (
            ...
            ('token', self.gf('django.db.models.fields.related.ForeignKey')(
                related_name='onetime_tokens', to=orm['users.AuthenticationToken'])),
        ))
        db.send_create_signal(u'users', ['OneTimeAuthenticationToken'])

    def backwards(self, orm):
        # Deleting model 'OneTimeAuthenticationToken'
        db.delete_table(u'users_onetimeauthenticationtoken')
