...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'AutomatedMail'
        db.create_table(u'users_automatedmail', (
            ...
            ('user', self.gf('django.db.models.fields.related.ForeignKey')
             (related_name='automated_mails', to=orm['auth.User'])),
            ('mailtype', self.gf('django.db.models.fields.CharField')
             (default='', max_length=20)),
        ))
        db.send_create_signal(u'users', ['AutomatedMail'])

        # Adding model 'UserActivity'
        db.create_table(u'users_useractivity', (
            (u'id', self.gf('django.db.models.fields.AutoField')
             (primary_key=True)),
            ('created', self.gf('django.db.models.fields.DateTimeField')
             (auto_now_add=True, blank=True)),
            ...
            ('user', self.gf('django.db.models.fields.related.OneToOneField')
             (related_name='activity', unique=True, to=orm['auth.User'])),
            ('last_seen', self.gf('django.db.models.fields.DateTimeField')
             (auto_now_add=True, blank=True)),
        ))
        db.send_create_signal(u'users', ['UserActivity'])

    def backwards(self, orm):
        # Deleting model 'AutomatedMail'
        db.delete_table(u'users_automatedmail')

        # Deleting model 'UserActivity'
        db.delete_table(u'users_useractivity')
