...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'UserSettings.client_id'
        db.add_column(u'users_usersettings', 'client_id',
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'UserSettings.client_id'
        db.delete_column(u'users_usersettings', 'client_id')
    ...
    models = {
        ...
        u'users.usersettings': {
            ...
            'client_id': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '10', 'null': 'True'}),
