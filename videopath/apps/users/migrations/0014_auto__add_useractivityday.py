...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'UserActivityDay'
        db.create_table(u'users_useractivityday', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('created', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
            ('modified', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, blank=True)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(related_name='user_activity_day', to=orm['auth.User'])),
            ('day', self.gf('django.db.models.fields.DateField')(auto_now_add=True, blank=True)),
        ))
        db.send_create_signal(u'users', ['UserActivityDay'])


    def backwards(self, orm):
        # Deleting model 'UserActivityDay'
        db.delete_table(u'users_useractivityday')
    ...
    models = {
        ...
        u'users.useractivityday': {
            'Meta': {'object_name': 'UserActivityDay'},
            'created': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'day': ('django.db.models.fields.DateField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'modified': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'blank': 'True'}),
            'user': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'user_activity_day'", 'to': u"orm['auth.User']"})
        },
