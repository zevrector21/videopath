...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding unique constraint on 'UserActivityDay', fields ['user', 'day']
        db.create_unique(u'users_useractivityday', ['user_id', 'day'])


    def backwards(self, orm):
        # Removing unique constraint on 'UserActivityDay', fields ['user', 'day']
        db.delete_unique(u'users_useractivityday', ['user_id', 'day'])
    ...
    models = {
        ...
        u'users.useractivityday': {
            'Meta': {'unique_together': "(('user', 'day'),)", 'object_name': 'UserActivityDay'},
            'created': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
