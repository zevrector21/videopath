...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'UserSettings.video_appearance'
        db.delete_column(u'users_usersettings', 'video_appearance')


    def backwards(self, orm):
        # Adding field 'UserSettings.video_appearance'
        db.add_column(u'users_usersettings', 'video_appearance',
