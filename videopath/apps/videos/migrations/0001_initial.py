...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'videos_video', (
            ...
            ('user', self.gf('django.db.models.fields.related.ForeignKey')
             (related_name='videos', to=orm['auth.User'])),
            ...
            ('draft', self.gf('django.db.models.fields.related.OneToOneField')(
                blank=True, related_name='video_draft', unique=True, null=True, to=orm['videos.VideoRevision'])),
            ('current_revision', self.gf('django.db.models.fields.related.OneToOneField')(
                blank=True, related_name='video_current', unique=True, null=True, to=orm['videos.VideoRevision'])),
        ))
        db.send_create_signal(u'videos', ['Video'])

        # Adding model 'VideoRevision'
        db.create_table(u'videos_videorevision', (
            (u'id', self.gf('django.db.models.fields.AutoField')
             (primary_key=True)),
            ('created', self.gf('django.db.models.fields.DateTimeField')
             (auto_now_add=True, blank=True)),
            ...
            ('video', self.gf('django.db.models.fields.related.ForeignKey')
             (related_name='revisions', to=orm['videos.Video'])),
            ('title', self.gf('django.db.models.fields.CharField')
             (default='New Video', max_length=50)),
            ('description', self.gf(
        ...
        db.send_create_signal(u'videos', ['VideoRevision'])

        # Adding model 'Marker'
        db.create_table(u'videos_marker', (
            (u'id', self.gf('django.db.models.fields.AutoField')
             (primary_key=True)),
            ('created', self.gf('django.db.models.fields.DateTimeField')
             (auto_now_add=True, blank=True)),
            ('modified', self.gf('django.db.models.fields.DateTimeField')
             (auto_now=True, blank=True)),
            ('video_revision', self.gf('django.db.models.fields.related.ForeignKey')(
                related_name='markers', to=orm['videos.VideoRevision'])),
            ('title', self.gf('django.db.models.fields.CharField')
             (max_length=100)),
            ('time', self.gf('django.db.models.fields.FloatField')(default=0)),
        ))
        db.send_create_signal(u'videos', ['Marker'])

        # Adding model 'MarkerContent'
        db.create_table(u'videos_markercontent', (
            (u'id', self.gf('django.db.models.fields.AutoField')
             (primary_key=True)),
            ('created', self.gf('django.db.models.fields.DateTimeField')
             (auto_now_add=True, blank=True)),
            ('modified', self.gf('django.db.models.fields.DateTimeField')
             (auto_now=True, blank=True)),
            ('marker', self.gf('django.db.models.fields.related.ForeignKey')
             (related_name='contents', to=orm['videos.Marker'])),
        ...
        db.send_create_signal(u'videos', ['MarkerContent'])

    def backwards(self, orm):
        # Deleting model 'Video'
        db.delete_table(u'videos_video')

        # Deleting model 'VideoRevision'
        db.delete_table(u'videos_videorevision')

        # Deleting model 'Marker'
        db.delete_table(u'videos_marker')

        # Deleting model 'MarkerContent'
        db.delete_table(u'videos_markercontent')
    ...
    models = {
        ...
        u'videos.video': {
            ...
            'created': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'current_revision': ('django.db.models.fields.related.OneToOneField', [], {'blank': 'True', 'related_name': "'video_current'", 'unique': 'True', 'null': 'True', 'to': u"orm['videos.VideoRevision']"}),
            'draft': ('django.db.models.fields.related.OneToOneField', [], {'blank': 'True', 'related_name': "'video_draft'", 'unique': 'True', 'null': 'True', 'to': u"orm['videos.VideoRevision']"}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
