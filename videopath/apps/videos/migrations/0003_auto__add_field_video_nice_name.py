...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Video.nice_name'
        db.add_column(u'videos_video', 'nice_name',
                      self.gf('django.db.models.fields.CharField')(
                          db_index=True, default='', max_length=50, blank=True),
                      keep_default=False)

    def backwards(self, orm):
        # Deleting field 'Video.nice_name'
        db.delete_column(u'videos_video', 'nice_name')
