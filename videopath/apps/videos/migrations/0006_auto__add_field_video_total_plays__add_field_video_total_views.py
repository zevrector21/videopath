...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Video.total_plays'
        db.add_column(u'videos_video', 'total_plays',
                      self.gf('django.db.models.fields.IntegerField')(
                          default=0),
                      keep_default=False)

        # Adding field 'Video.total_views'
        db.add_column(u'videos_video', 'total_views',
                      self.gf('django.db.models.fields.IntegerField')(
                          default=0),
                      keep_default=False)

    def backwards(self, orm):
        # Deleting field 'Video.total_plays'
        db.delete_column(u'videos_video', 'total_plays')

        # Deleting field 'Video.total_views'
        db.delete_column(u'videos_video', 'total_views')
