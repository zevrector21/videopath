...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Marker.overlay_width'
        db.add_column(u'videos_marker', 'overlay_width',
                      self.gf('django.db.models.fields.IntegerField')(
                          default=-1),
                      keep_default=False)

        # Adding field 'Marker.overlay_height'
        db.add_column(u'videos_marker', 'overlay_height',
                      self.gf('django.db.models.fields.IntegerField')(
                          default=-1),
                      keep_default=False)

    def backwards(self, orm):
        # Deleting field 'Marker.overlay_width'
        db.delete_column(u'videos_marker', 'overlay_width')

        # Deleting field 'Marker.overlay_height'
        db.delete_column(u'videos_marker', 'overlay_height')
