...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Video.player_version'
        db.add_column(u'videos_video', 'player_version',
                      self.gf('django.db.models.fields.CharField')(
                          default='1', max_length=20),
                      keep_default=False)

    def backwards(self, orm):
        # Deleting field 'Video.player_version'
        db.delete_column(u'videos_video', 'player_version')
    ...
    models = {
        ...
        u'videos.video': {
            ...
            'player_version': ('django.db.models.fields.CharField', [], {'default': "'1'", 'max_length': '20'}),
