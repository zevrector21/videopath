...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'videos_endscreen', (
            ...
            ('title', self.gf('django.db.models.fields.CharField')
             (db_index=True, max_length=512, blank=True)),
    ...
    models = {
        ...
        u'videos.endscreen': {
            'Meta': {'object_name': 'Endscreen'},
            'background_color': ('videopath.apps.models.ColorField', [], {'default': "'#32526e'", 'max_length': '10', 'blank': 'True'}),
            'button_target': ('django.db.models.fields.CharField', [], {'db_index': 'True', 'max_length': '512', 'blank': 'True'}),
            'button_title': ('django.db.models.fields.CharField', [], {'db_index': 'True', 'max_length': '512', 'blank': 'True'}),
            'created': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'modified': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'blank': 'True'}),
            'title': ('django.db.models.fields.CharField', [], {'db_index': 'True', 'max_length': '512', 'blank': 'True'}),
            'video_revision': ('django.db.models.fields.related.OneToOneField', [], {'related_name': "'endscreen'", 'unique': 'True', 'to': u"orm['videos.VideoRevision']"})
        },
        u'videos.marker': {
