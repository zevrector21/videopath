...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Endscreen.button_color'
        db.add_column(u'videos_endscreen', 'button_color',
                      self.gf('videopath.apps.models.ColorField')(
                          default='#ff6b57', max_length=10, blank=True),
                      keep_default=False)

    def backwards(self, orm):
        # Deleting field 'Endscreen.button_color'
        db.delete_column(u'videos_endscreen', 'button_color')
    ...
    models = {
        ...
        u'videos.endscreen': {
            ...
            'button_color': ('videopath.apps.models.ColorField', [], {'default': "'#ff6b57'", 'max_length': '10', 'blank': 'True'}),
