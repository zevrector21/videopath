...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting model 'Endscreen'
        db.delete_table(u'videos_endscreen')

        # Adding field 'VideoRevision.endscreen_title'
        db.add_column(u'videos_videorevision', 'endscreen_title',
                      self.gf('django.db.models.fields.CharField')(
                          default='', max_length=512, blank=True),
                      keep_default=False)

        # Adding field 'VideoRevision.endscreen_background_color'
        db.add_column(u'videos_videorevision', 'endscreen_background_color',
                      self.gf('videopath.apps.models.ColorField')(
                          default='#32526e', max_length=10, blank=True),
                      keep_default=False)

        # Adding field 'VideoRevision.endscreen_button_title'
        db.add_column(u'videos_videorevision', 'endscreen_button_title',
                      self.gf('django.db.models.fields.CharField')(
                          default='', max_length=512, blank=True),
                      keep_default=False)

        # Adding field 'VideoRevision.endscreen_button_target'
        db.add_column(u'videos_videorevision', 'endscreen_button_target',
                      self.gf('django.db.models.fields.CharField')(
                          default='', max_length=512, blank=True),
                      keep_default=False)

        # Adding field 'VideoRevision.endscreen_button_color'
        db.add_column(u'videos_videorevision', 'endscreen_button_color',
                      self.gf('videopath.apps.models.ColorField')(
                          default='#ff6b57', max_length=10, blank=True),
                      keep_default=False)

    def backwards(self, orm):
        # Adding model 'Endscreen'
        db.create_table(u'videos_endscreen', (
            ('button_color', self.gf('videopath.apps.models.ColorField')
             (default='#ff6b57', max_length=10, blank=True)),
            ('button_target', self.gf('django.db.models.fields.CharField')
             (blank=True, max_length=512, db_index=True)),
            ('video_revision', self.gf('django.db.models.fields.related.OneToOneField')(
                related_name='endscreen', unique=True, to=orm['videos.VideoRevision'])),
            ...
            ('background_color', self.gf('videopath.apps.models.ColorField')
             (default='#32526e', max_length=10, blank=True)),
        ...
        db.send_create_signal(u'videos', ['Endscreen'])

        # Deleting field 'VideoRevision.endscreen_title'
        db.delete_column(u'videos_videorevision', 'endscreen_title')

        # Deleting field 'VideoRevision.endscreen_background_color'
        db.delete_column(u'videos_videorevision', 'endscreen_background_color')

        # Deleting field 'VideoRevision.endscreen_button_title'
        db.delete_column(u'videos_videorevision', 'endscreen_button_title')

        # Deleting field 'VideoRevision.endscreen_button_target'
        db.delete_column(u'videos_videorevision', 'endscreen_button_target')

        # Deleting field 'VideoRevision.endscreen_button_color'
        db.delete_column(u'videos_videorevision', 'endscreen_button_color')
    ...
    models = {
        ...
        u'videos.videorevision': {
            ...
            'endscreen_button_target': ('django.db.models.fields.CharField', [], {'max_length': '512', 'blank': 'True'}),
            'endscreen_button_title': ('django.db.models.fields.CharField', [], {'max_length': '512', 'blank': 'True'}),
