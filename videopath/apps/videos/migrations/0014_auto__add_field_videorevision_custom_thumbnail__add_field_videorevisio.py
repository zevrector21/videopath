...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'VideoRevision.custom_thumbnail'
        db.add_column(u'videos_videorevision', 'custom_thumbnail',
                      self.gf('django.db.models.fields.related.ForeignKey')(
                          default=None, related_name='video_thumbnail', null=True, blank=True, to=orm['files.ImageFile']),
                      keep_default=False)

        # Adding field 'VideoRevision.custom_logo'
        db.add_column(u'videos_videorevision', 'custom_logo',
                      self.gf('django.db.models.fields.related.ForeignKey')(
                          default=None, related_name='video_logo', null=True, blank=True, to=orm['files.ImageFile']),
                      keep_default=False)

    def backwards(self, orm):
        # Deleting field 'VideoRevision.custom_thumbnail'
        db.delete_column(u'videos_videorevision', 'custom_thumbnail_id')
