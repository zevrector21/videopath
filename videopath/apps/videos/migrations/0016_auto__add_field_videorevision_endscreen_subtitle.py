...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'VideoRevision.endscreen_subtitle'
        db.add_column(u'videos_videorevision', 'endscreen_subtitle',
                      self.gf('django.db.models.fields.CharField')(
                          default='', max_length=512, blank=True),
                      keep_default=False)

    def backwards(self, orm):
        # Deleting field 'VideoRevision.endscreen_subtitle'
        db.delete_column(u'videos_videorevision', 'endscreen_subtitle')
