...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'VideoRevision.appearance'
        db.delete_column(u'videos_videorevision', 'appearance')

        # Adding field 'VideoRevision.video_appearance'
        db.add_column(u'videos_videorevision', 'video_appearance',
                      self.gf('django.db.models.fields.TextField')(default='', blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'VideoRevision.appearance'
        db.add_column(u'videos_videorevision', 'appearance',
                      self.gf('django.db.models.fields.TextField')(default='', blank=True),
                      keep_default=False)

        # Deleting field 'VideoRevision.video_appearance'
        db.delete_column(u'videos_videorevision', 'video_appearance')
