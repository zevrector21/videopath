...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'VideoRevision.ui_color_1'
        db.add_column(u'videos_videorevision', 'ui_color_1',
                      self.gf('videopath.apps.models.ColorField')(default='#424242', max_length=10),
                      keep_default=False)

        # Adding field 'VideoRevision.ui_color_2'
        db.add_column(u'videos_videorevision', 'ui_color_2',
                      self.gf('videopath.apps.models.ColorField')(default='#ffffff', max_length=10),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'VideoRevision.ui_color_1'
        db.delete_column(u'videos_videorevision', 'ui_color_1')

        # Deleting field 'VideoRevision.ui_color_2'
        db.delete_column(u'videos_videorevision', 'ui_color_2')
