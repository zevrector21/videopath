...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'VideoRevision.title'
        db.alter_column(u'videos_videorevision', 'title', self.gf('django.db.models.fields.CharField')(max_length=255))

    def backwards(self, orm):

        # Changing field 'VideoRevision.title'
        db.alter_column(u'videos_videorevision', 'title', self.gf('django.db.models.fields.CharField')(max_length=50))
