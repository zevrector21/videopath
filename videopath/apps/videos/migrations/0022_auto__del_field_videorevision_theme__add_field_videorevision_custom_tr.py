...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'VideoRevision.theme'
        db.delete_column(u'videos_videorevision', 'theme')

        # Adding field 'VideoRevision.custom_tracking_code'
        db.add_column(u'videos_videorevision', 'custom_tracking_code',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=20, blank=True),
                      keep_default=False)

        # Adding field 'VideoRevision.ui_disable_share_buttons'
        db.add_column(u'videos_videorevision', 'ui_disable_share_buttons',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'VideoRevision.ui_equal_marker_lenghts'
        db.add_column(u'videos_videorevision', 'ui_equal_marker_lenghts',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'VideoRevision.theme'
        db.add_column(u'videos_videorevision', 'theme',
                      self.gf('django.db.models.fields.IntegerField')(default=1),
                      keep_default=False)

        # Deleting field 'VideoRevision.custom_tracking_code'
        db.delete_column(u'videos_videorevision', 'custom_tracking_code')

        # Deleting field 'VideoRevision.ui_disable_share_buttons'
        db.delete_column(u'videos_videorevision', 'ui_disable_share_buttons')

        # Deleting field 'VideoRevision.ui_equal_marker_lenghts'
        db.delete_column(u'videos_videorevision', 'ui_equal_marker_lenghts')
