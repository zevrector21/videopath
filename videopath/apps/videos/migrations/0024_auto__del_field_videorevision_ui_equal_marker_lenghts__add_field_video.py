...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'VideoRevision.ui_equal_marker_lengths'
        db.add_column(u'videos_videorevision', 'ui_equal_marker_lengths',
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'VideoRevision.ui_equal_marker_lengths'
        db.delete_column(u'videos_videorevision', 'ui_equal_marker_lengths')
