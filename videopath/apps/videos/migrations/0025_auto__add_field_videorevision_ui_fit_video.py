...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'VideoRevision.ui_fit_video'
        db.add_column(u'videos_videorevision', 'ui_fit_video',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'VideoRevision.ui_fit_video'
        db.delete_column(u'videos_videorevision', 'ui_fit_video')
