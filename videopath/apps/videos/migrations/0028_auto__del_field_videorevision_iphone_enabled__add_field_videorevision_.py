...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'VideoRevision.iphone_enabled'
        db.delete_column(u'videos_videorevision', 'iphone_enabled')

        # Adding field 'VideoRevision.iphone_images'
        db.add_column(u'videos_videorevision', 'iphone_images',
                      self.gf('django.db.models.fields.IntegerField')(default=-1),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'VideoRevision.iphone_enabled'
        db.add_column(u'videos_videorevision', 'iphone_enabled',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Deleting field 'VideoRevision.iphone_images'
        db.delete_column(u'videos_videorevision', 'iphone_images')
