...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'PlayerAppearance'
        db.create_table(u'videos_playerappearance', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('created', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
            ('modified', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, blank=True)),
            ('description', self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True)),
            ('video_revision', self.gf('django.db.models.fields.related.OneToOneField')(related_name='appearance', unique=True, to=orm['videos.VideoRevision'])),
            ('user', self.gf('django.db.models.fields.related.OneToOneField')(related_name='default_player_appearance', unique=True, to=orm['auth.User'])),
            ('ui_color_1', self.gf('videopath.apps.common.models.ColorField')(max_length=10, null=True, blank=True)),
            ('ui_color_2', self.gf('videopath.apps.common.models.ColorField')(max_length=10, null=True, blank=True)),
            ('ui_color_playbar_outline', self.gf('videopath.apps.common.models.ColorField')(max_length=10, null=True, blank=True)),
            ('ui_color_playbar_background', self.gf('videopath.apps.common.models.ColorField')(max_length=10, null=True, blank=True)),
            ('ui_color_playbar_progress', self.gf('videopath.apps.common.models.ColorField')(max_length=10, null=True, blank=True)),
            ('ui_color_playbar_buffer', self.gf('videopath.apps.common.models.ColorField')(max_length=10, null=True, blank=True)),
            ('ui_color_marker_background', self.gf('videopath.apps.common.models.ColorField')(max_length=10, null=True, blank=True)),
            ('ui_color_marker_outline', self.gf('videopath.apps.common.models.ColorField')(max_length=10, null=True, blank=True)),
            ('ui_color_marker_text', self.gf('videopath.apps.common.models.ColorField')(max_length=10, null=True, blank=True)),
            ('ui_color_marker_highlight_background', self.gf('videopath.apps.common.models.ColorField')(max_length=10, null=True, blank=True)),
            ('ui_color_marker_highlight_outline', self.gf('videopath.apps.common.models.ColorField')(max_length=10, null=True, blank=True)),
            ('ui_color_marker_highlight_text', self.gf('videopath.apps.common.models.ColorField')(max_length=10, null=True, blank=True)),
            ('ui_color_button_background', self.gf('videopath.apps.common.models.ColorField')(max_length=10, null=True, blank=True)),
            ('ui_color_button_text', self.gf('videopath.apps.common.models.ColorField')(max_length=10, null=True, blank=True)),
            ('ui_color_button_highlight_background', self.gf('videopath.apps.common.models.ColorField')(max_length=10, null=True, blank=True)),
            ('ui_color_button_highlight_text', self.gf('videopath.apps.common.models.ColorField')(max_length=10, null=True, blank=True)),
            ('ui_color_overlay_outline', self.gf('videopath.apps.common.models.ColorField')(max_length=10, null=True, blank=True)),
            ('ui_font_marker', self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True)),
            ('ui_font_overlay_titles', self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True)),
            ('ui_font_overlay_text', self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True)),
            ('endscreen_logo', self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True)),
            ('icon', self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True)),
            ('language', self.gf('django.db.models.fields.CharField')(default='en', max_length=50)),
            ('sharing_disabled', self.gf('django.db.models.fields.BooleanField')(default=False)),
        ))
        db.send_create_signal('videos', ['PlayerAppearance'])


    def backwards(self, orm):
        # Deleting model 'PlayerAppearance'
        db.delete_table(u'videos_playerappearance')
    ...
    models = {
        ...
        'videos.playerappearance': {
            ...
            'user': ('django.db.models.fields.related.OneToOneField', [], {'related_name': "'default_player_appearance'", 'unique': 'True', 'to': u"orm['auth.User']"}),
            'video_revision': ('django.db.models.fields.related.OneToOneField', [], {'related_name': "'appearance'", 'unique': 'True', 'to': "orm['videos.VideoRevision']"})
        },
        'videos.video': {
