...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'PlayerAppearance.ui_color_playbar_indicators'
        db.add_column(u'videos_playerappearance', 'ui_color_playbar_indicators',
                      self.gf('videopath.apps.common.models.ColorField')(max_length=10, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'PlayerAppearance.ui_color_playbar_indicators'
        db.delete_column(u'videos_playerappearance', 'ui_color_playbar_indicators')
    ...
    models = {
        ...
        'videos.playerappearance': {
            ...
            'video_revision': ('django.db.models.fields.related.OneToOneField', [], {'blank': 'True', 'related_name': "'player_appearance'", 'unique': 'True', 'null': 'True', 'to': "orm['videos.VideoRevision']"})
        },
        'videos.video': {
