...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Removing unique constraint on 'PlayerAppearance', fields ['video_revision']
        db.delete_unique(u'videos_playerappearance', ['video_revision_id'])


        # Changing field 'PlayerAppearance.video_revision'
        db.alter_column(u'videos_playerappearance', 'video_revision_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['videos.VideoRevision']))
    ...
    def backwards(self, orm):
        ...
        # Adding unique constraint on 'PlayerAppearance', fields ['video_revision']
        db.create_unique(u'videos_playerappearance', ['video_revision_id'])
    ...
    models = {
        ...
        'videos.playerappearance': {
            ...
            'video_revision': ('django.db.models.fields.related.ForeignKey', [], {'default': 'None', 'related_name': "'player_appearance'", 'null': 'True', 'blank': 'True', 'to': "orm['videos.VideoRevision']"})
        },
        'videos.video': {
