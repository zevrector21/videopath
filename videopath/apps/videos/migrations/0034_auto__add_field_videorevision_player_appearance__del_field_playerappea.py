...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'VideoRevision.player_appearance'
        db.add_column(u'videos_videorevision', 'player_appearance',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=None, related_name='video_revisions', null=True, blank=True, to=orm['videos.PlayerAppearance']),
                      keep_default=False)

        # Deleting field 'PlayerAppearance.video_revision'
        db.delete_column(u'videos_playerappearance', 'video_revision_id')


    def backwards(self, orm):
        # Deleting field 'VideoRevision.player_appearance'
        db.delete_column(u'videos_videorevision', 'player_appearance_id')

        # Adding field 'PlayerAppearance.video_revision'
        db.add_column(u'videos_playerappearance', 'video_revision',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=None, related_name='player_appearance', null=True, to=orm['videos.VideoRevision'], blank=True),
                      keep_default=False)
