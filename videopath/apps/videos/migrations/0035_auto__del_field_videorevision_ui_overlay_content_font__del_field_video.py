...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'VideoRevision.ui_overlay_content_font'
        db.delete_column(u'videos_videorevision', 'ui_overlay_content_font')

        # Deleting field 'VideoRevision.revision_number'
        db.delete_column(u'videos_videorevision', 'revision_number')

        # Deleting field 'VideoRevision.custom_logo'
        db.delete_column(u'videos_videorevision', 'custom_logo_id')

        # Deleting field 'VideoRevision.ui_marker_font'
        db.delete_column(u'videos_videorevision', 'ui_marker_font')

        # Deleting field 'VideoRevision.ui_overlay_title_font'
        db.delete_column(u'videos_videorevision', 'ui_overlay_title_font')


    def backwards(self, orm):
        # Adding field 'VideoRevision.ui_overlay_content_font'
        db.add_column(u'videos_videorevision', 'ui_overlay_content_font',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=512, blank=True),
                      keep_default=False)

        # Adding field 'VideoRevision.revision_number'
        db.add_column(u'videos_videorevision', 'revision_number',
                      self.gf('django.db.models.fields.IntegerField')(default=1),
                      keep_default=False)

        # Adding field 'VideoRevision.custom_logo'
        db.add_column(u'videos_videorevision', 'custom_logo',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=None, related_name='video_logo', null=True, to=orm['files.ImageFile'], blank=True),
                      keep_default=False)

        # Adding field 'VideoRevision.ui_marker_font'
        db.add_column(u'videos_videorevision', 'ui_marker_font',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=512, blank=True),
                      keep_default=False)

        # Adding field 'VideoRevision.ui_overlay_title_font'
        db.add_column(u'videos_videorevision', 'ui_overlay_title_font',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=512, blank=True),
                      keep_default=False)
    ...
    models = {
        ...
        'videos.playerappearance': {
            ...
            'user': ('django.db.models.fields.related.OneToOneField', [], {'blank': 'True', 'related_name': "'default_player_appearance'", 'unique': 'True', 'null': 'True', 'to': u"orm['auth.User']"})
        },
        'videos.video': {
        ...
        'videos.videorevision': {
            ...
            'modified': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'blank': 'True'}),
            'player_appearance': ('django.db.models.fields.related.ForeignKey', [], {'default': 'None', 'related_name': "'video_revisions'", 'null': 'True', 'blank': 'True', 'to': "orm['videos.PlayerAppearance']"}),
